...
## [4.12.1](https://github.com/nedelnitsyn13/bedolaga/compare/v4.15.0...v4.12.1) (2026-09-25)
...
* **admin:** стартовое уведомление — сводка по разделам и блок «требует внимания» ([28c9419](https://github.com/nedelnitsyn13/bedolaga/commit/28c9419bf60b2f437197874650c07fcbbe61d800))
...
* **admin:** уведомление об остановке бота — причина, аптайм, что делать дальше ([36db98c](https://github.com/nedelnitsyn13/bedolaga/commit/36db98c0931f5fc9b58ba295a31e8abed6f5f04e))
...
* **cabinet:** «онлайн» в списке пользователей — подключение к VPN по панели, а не кнопки в боте ([17dc74a](https://github.com/nedelnitsyn13/bedolaga/commit/17dc74a5c9061603a35a77bba073c31dcd7ee89c))
...
* **cabinet:** web app manifest и иконки приложения по URL ([4b58b3a](https://github.com/nedelnitsyn13/bedolaga/commit/4b58b3a4026202faee7cfa1eb8a11196322666de))
* **cabinet:** web app manifest и иконки приложения по URL ([1f9972d](https://github.com/nedelnitsyn13/bedolaga/commit/1f9972d930068c7c018112599f458e8db8f5e0be))
...
* **cabinet:** карточка пользователя знает режим продаж — sales_mode и multi_tariff_enabled в ответе ([fbd5ea5](https://github.com/nedelnitsyn13/bedolaga/commit/fbd5ea52b446ad056b1aa2b2cb6649aa87d7f488))
...
* **cabinet:** фильтр списка пользователей «трафик на исходе» — израсходовано от N % лимита ([152dbd5](https://github.com/nedelnitsyn13/bedolaga/commit/152dbd5616aaaf91f339c3c29467ba9a0974c4df))
* **cabinet:** фильтры списка пользователей — истекают, онлайн, без покупок, без подписки, ограничения; email в общем поиске ([7fd9b17](https://github.com/nedelnitsyn13/bedolaga/commit/7fd9b17ab6dfe1c3667c83d55c83b5b00aaf7017))
...
* **grace:** обнулять счётчик трафика при выдаче grace по настройке ([9bd7f0f](https://github.com/nedelnitsyn13/bedolaga/commit/9bd7f0fabdcadf9008ff27b62f1b68510de25439)), closes [#3275](https://github.com/nedelnitsyn13/bedolaga/issues/3275)
...
* **promo-groups:** пересчёт групп по тратам при правке групп и по кнопке в кабинете ([d05dd5f](https://github.com/nedelnitsyn13/bedolaga/commit/d05dd5f7e71c6305cb2cd999757e9da94b54dcc4))
* **promo-groups:** уведомлять клиента об автоназначении и email-рассылка по промогруппе/одному человеку ([013b86f](https://github.com/nedelnitsyn13/bedolaga/commit/013b86fca29da537e2a4198b2c9ce67b895fa2dc)), closes [#3271](https://github.com/nedelnitsyn13/bedolaga/issues/3271)
...
* **referral:** напоминания о заявках на вывод без решения ([da6dea1](https://github.com/nedelnitsyn13/bedolaga/commit/da6dea13814bb041673e6ba0257656aa2d89802b))
* **reminders:** админ-API напоминаний — CRUD, аудитория, тест себе, права ([6633719](https://github.com/nedelnitsyn13/bedolaga/commit/663371989895e49fbbcb14d3890abb94bd05afee))
* **reminders:** выборки, состояние по человеку и счётчик аудитории ([4c59bd7](https://github.com/nedelnitsyn13/bedolaga/commit/4c59bd72ddf13709fd45a33bec3d1635729864b4))
* **reminders:** карточки напоминаний в кабинете и их закрытие ([0fe6eb0](https://github.com/nedelnitsyn13/bedolaga/commit/0fe6eb0d4de93f6823efc603ebf9a1b9e1029aa1))
* **reminders:** отправка напоминаний в бот — частота, лимиты, тихие часы ([2706a7e](https://github.com/nedelnitsyn13/bedolaga/commit/2706a7ea57d51673d5bbbe1b9458d0caa000b809))
* **reminders:** таблицы напоминаний и встроенное «второй способ входа» (миграция 0127) ([5aac9e7](https://github.com/nedelnitsyn13/bedolaga/commit/5aac9e774af09efe0288f1ebc181fdf43bb98a83))
* **reminders:** тексты напоминаний — языки, кнопка, рендер для бота и кабинета ([449128d](https://github.com/nedelnitsyn13/bedolaga/commit/449128d203fc5d2b80cd59335ab7d619a1eae7d8))
* **reminders:** условия напоминаний — один вычислитель для бота и кабинета ([220d2e5](https://github.com/nedelnitsyn13/bedolaga/commit/220d2e5588094753177a3de0163d177265e64e40))
...
* **subscription:** у старой подписки без тарифа нет продления — только переход на тариф ([1eace6c](https://github.com/nedelnitsyn13/bedolaga/commit/1eace6c42d7f7633bf42e14c82f46937e5b3e60a))
...
* сегмент «В грейсе» в списке пользователей ([f268d47](https://github.com/nedelnitsyn13/bedolaga/commit/f268d4700a3da37e4704cdab3bd2d39b4332e309))
...
* сортировка пользователей в админке в обе стороны ([c69f7b1](https://github.com/nedelnitsyn13/bedolaga/commit/c69f7b1c75580ba93bef6752377b0f86e94334e9))
* сортировка пользователей по концу временного доступа ([0961619](https://github.com/nedelnitsyn13/bedolaga/commit/09616190b5a89ad023fdc3fd4076da7040a7e79d))
...
* «онлайн» в списке показывал тех, кто отключился минуту назад ([d0b56a9](https://github.com/nedelnitsyn13/bedolaga/commit/d0b56a9448e44e259c40a0c1526ec5c80b661abd))
...
* «Сбросить триал» в кабинете действительно открывает триал заново ([59f2c23](https://github.com/nedelnitsyn13/bedolaga/commit/59f2c23f44289a6eb02c7649f4736b9f8cdd69ea))
...
* **account-linking:** предлагать слияние при привязке соцсети, занятой другим аккаунтом ([0906108](https://github.com/nedelnitsyn13/bedolaga/commit/0906108b0bdb7294e3cd2c6953102ad286ff217a)), closes [#3263](https://github.com/nedelnitsyn13/bedolaga/issues/3263)
...
* **admin-chat:** в групповом админ-чате не рисовать кнопки, которые там не работают ([7af785e](https://github.com/nedelnitsyn13/bedolaga/commit/7af785e994a252b1cb1bcf2664a3876c417c7021))
* **admin/payments:** отображать успешные Platega СБП автопродления ([d8ff465](https://github.com/nedelnitsyn13/bedolaga/commit/d8ff4654626b5fa2afe46aa582731e97ea25a170))
...
* **admin:** сегменты «Пользователей» считают по подписке, а не по сырому статусу ([bf6c7eb](https://github.com/nedelnitsyn13/bedolaga/commit/bf6c7ebf2501e64b1c07abc22a02e458415e8c43))
...
* **branding:** у иконки приложения на Android больше нет чёрных полосок по краям ([f74a91b](https://github.com/nedelnitsyn13/bedolaga/commit/f74a91b5c98879f3fb2bc15a1f3e53984969c351))
* **broadcasts:** одно письмо на человека в фильтрах по подписке ([738fcd8](https://github.com/nedelnitsyn13/bedolaga/commit/738fcd83a5e07aecc74b5c8d9521ec719f79ad30))
...
* **cabinet:** вход по Telegram забирает фантома с лендинга, а не заводит второй аккаунт ([#3247](https://github.com/nedelnitsyn13/bedolaga/issues/3247)) ([124cae4](https://github.com/nedelnitsyn13/bedolaga/commit/124cae4314c1e483dad14c940d00cb2a133e2613))
...
* **cabinet:** исправить email-регистрацию по приглашениям ([e5685b0](https://github.com/nedelnitsyn13/bedolaga/commit/e5685b0e832add1c84507678a1bc8337bbfbfa4f))
* **cabinet:** исправить email-регистрацию по приглашениям ([d598915](https://github.com/nedelnitsyn13/bedolaga/commit/d598915f083fae5a041d6259124a45dbad875274))
...
* **cabinet:** покупка тарифа из кабинета спрашивает настройки сброса трафика ([#3227](https://github.com/nedelnitsyn13/bedolaga/issues/3227)) ([105f401](https://github.com/nedelnitsyn13/bedolaga/commit/105f40187f8435548cea4fa9cc12389715d35880))
...
* **grace:** грейс по лимиту закрывается, когда трафик сбросился по расписанию ([95519e0](https://github.com/nedelnitsyn13/bedolaga/commit/95519e0c9a085045278d44ae608e01ec5e8b29cd))
...
* **grace:** продление лечит подписки, испорченные грейсом в 4.10–4.11; гонки мониторинга закрыты ([5cb9f72](https://github.com/nedelnitsyn13/bedolaga/commit/5cb9f729517438b1cae649693490c7e4da4d5d8c))
* **grace:** синхронизация и мониторинг больше не ломают грейс — оверлей не принимается за продление ([65c92d6](https://github.com/nedelnitsyn13/bedolaga/commit/65c92d675ef8810d012a755261b9916b4fac638e))
...
* **lint:** вернуть noqa ASYNC240 в message_patch ([98e8f18](https://github.com/nedelnitsyn13/bedolaga/commit/98e8f18c9ff0a24f11347107df5093d23a1b426f))
...
* **logging:** обрывы getUpdates не уходят в админ-чат отчётом об ошибке ([48eea39](https://github.com/nedelnitsyn13/bedolaga/commit/48eea39d9208ada8b0d62d077609280b0d4c7aa9))
* **logging:** убрать устаревший грубый фильтр aiogram.dispatcher — заменён точным _is_transient_telegram_error ([6a96bfa](https://github.com/nedelnitsyn13/bedolaga/commit/6a96bfabfbb57d142272a14dc583bcffea98788c))
* **logo:** заменённый файл логотипа показывается сразу, без ручного ?v= ([a9d04ae](https://github.com/nedelnitsyn13/bedolaga/commit/a9d04ae616668ed2cf96450afe8c5b62d6013e59))
* **logs:** убрать следы вырезанных подстановок из сообщений логов ([a88f228](https://github.com/nedelnitsyn13/bedolaga/commit/a88f228278e065be87c3ae28a0e97418ded0dc57))
...
* **monitoring:** убрать пустой except при остановке цикла напоминаний ([3a67e20](https://github.com/nedelnitsyn13/bedolaga/commit/3a67e202e9d6b6dd6528c64058618bb83d27f520))
* **mulenpay:** безопасно принимать webhook без sign через API-проверку ([86c04fa](https://github.com/nedelnitsyn13/bedolaga/commit/86c04fa2422bfcbdee3c4989b0ec5f46a7781582))
* **mulenpay:** безопасно принимать webhook без sign через API-проверку ([d43d008](https://github.com/nedelnitsyn13/bedolaga/commit/d43d008962069bf5a52ac30152a7dcee3e49a2c9))
* **mulenpay:** вебхук без sign не падает на не-объекте и не ходит в API за оплаченным платежом ([db53121](https://github.com/nedelnitsyn13/bedolaga/commit/db531211d95c333829d41dbf932ad672dcd30130))
* **nalogo:** чек НПД по покупке с лендинга только для оплат через YooKassa ([22e05b8](https://github.com/nedelnitsyn13/bedolaga/commit/22e05b806db43ce1502698b493faddde023b6003))
...
* **panel_sync:** чужой аккаунт панели больше не гасится и не присваивается ([#3245](https://github.com/nedelnitsyn13/bedolaga/issues/3245)) ([329a8d9](https://github.com/nedelnitsyn13/bedolaga/commit/329a8d9da27d0bc4e2bfc25a41e8551084e4c13d))
...
* **panel-sync:** записывать связь после пересоздания удалённой учётки ([0428a47](https://github.com/nedelnitsyn13/bedolaga/commit/0428a47f575817546eb116bdd17297cf857f8aeb))
...
* **panel-sync:** не откатывать оплаченный лимит трафика устаревшим снимком панели ([2490bee](https://github.com/nedelnitsyn13/bedolaga/commit/2490bee3e420a156166882441605fffce2cdbfd4))
* **panel-sync:** не откатывать оплаченный лимит трафика устаревшим снимком панели ([3b56dc4](https://github.com/nedelnitsyn13/bedolaga/commit/3b56dc450e324563715771624485b0dc9a5d4e74))
...
* **panel-sync:** снимок панели не укорачивает срок, за который недавно заплатили ([4b84808](https://github.com/nedelnitsyn13/bedolaga/commit/4b84808b395303bc7b38027bff9190ed084135a0))
* **panel:** «удалил подписку → купил заново» больше не наследует удалённый аккаунт панели ([8e37e78](https://github.com/nedelnitsyn13/bedolaga/commit/8e37e7805b46a5535f8f208fee149ebc4c69c300))
* **panel:** при переходе на тариф и возврате в одиночный режим аккаунт панели не создаётся заново ([b4055f5](https://github.com/nedelnitsyn13/bedolaga/commit/b4055f5aeef9494151a22bd9ebcc06ab915fde20))
* **panel:** триальный тег снимается в панели после покупки подписки ([1578b4a](https://github.com/nedelnitsyn13/bedolaga/commit/1578b4a8cd35bac805a2509081c77e726edfd0d0))
* **payments:** данные плательщика в каждом платеже Platega и MulenPay ([fb5feb5](https://github.com/nedelnitsyn13/bedolaga/commit/fb5feb558b2a25e8842918e4f7ff272e271f2cea))
...
* **referral:** кнопки заявки на вывод работают в групповом админ-чате ([040b8b6](https://github.com/nedelnitsyn13/bedolaga/commit/040b8b6eca0cbc7253a3fdde73bdb2dd17faef3e))
* **referral:** напоминание о заявке на вывод — те же кнопки, что у исходного уведомления ([ae9878b](https://github.com/nedelnitsyn13/bedolaga/commit/ae9878bab85ac5d99dddd971d6cdb7b94bf9ede1))
...
* **reminders:** права на напоминания у ролей Admin и Marketer, тест себе не падает на битых текстах ([a1cb183](https://github.com/nedelnitsyn13/bedolaga/commit/a1cb1835ef9f9d43e9facf495a55990aa928ec25))
* **reminders:** устойчивость к гонке удаления, неизвестный тип кнопки, аудитория с учётом категории ([6e2c308](https://github.com/nedelnitsyn13/bedolaga/commit/6e2c308558f01f52d5e0262465143d9236cd9cfd))
...
* **scripts:** генератор структуры сортирует пути одинаково на Windows и Linux ([ccdc6ed](https://github.com/nedelnitsyn13/bedolaga/commit/ccdc6ed250667926dc781749c5fa9348d076eedb))
* **scripts:** генератор структуры сортирует пути одинаково на Windows и Linux ([e3f4964](https://github.com/nedelnitsyn13/bedolaga/commit/e3f4964a4d36124d95a67b6fe7069e083cac78f5))
...
* **subscription:** старой подписке не продавать докупки — только переход на тариф ([3201727](https://github.com/nedelnitsyn13/bedolaga/commit/3201727b3716d31e8e0d24c2401fb5e54977579a))
...
* **tickets:** кнопки карточки тикета работают в групповом админ-чате ([aa1514c](https://github.com/nedelnitsyn13/bedolaga/commit/aa1514cb4e43efc9c2c15f22b9239049d311955c))
...
* **yookassa:** уведомления за прокси обрабатываются по единым правилам ([4dc4ed4](https://github.com/nedelnitsyn13/bedolaga/commit/4dc4ed46468b25aaffdff314f61df30b4b49b494))
...
* временный доступ больше не выглядит расхождением с панелью ([635c926](https://github.com/nedelnitsyn13/bedolaga/commit/635c92637af8927e10a8934f3aeac9a28ceaf3b3))
...
* закрыть замечания ревью PR [#3280](https://github.com/nedelnitsyn13/bedolaga/issues/3280) ([a89a236](https://github.com/nedelnitsyn13/bedolaga/commit/a89a236a272e50646d993c308327180ff8fc3fd5))
...
* несколько тарифов у одного человека — выборки и строка списка ([4890df2](https://github.com/nedelnitsyn13/bedolaga/commit/4890df2f32d24c3f76520e25e16483088aba33d9))
...
* обрыв клиента на вебсокете больше не уходит в отчёт об ошибке ([3c24356](https://github.com/nedelnitsyn13/bedolaga/commit/3c2435607651491e0989e5254f255ae4b8aeaf9d))
...
* сортировка по трафику ломала выборки списка пользователей и повторяла людей ([c9499d1](https://github.com/nedelnitsyn13/bedolaga/commit/c9499d1eb30282683fcff12478073bb02becccb8))
...
* срок подписки считается по календарю, время — в поясе оператора ([8069186](https://github.com/nedelnitsyn13/bedolaga/commit/80691864b8906cd435eca6de89a243e553eff29b))
...
* у подписок, перенесённых из панели, 0 устройств в кабинете и боте ([4acebd1](https://github.com/nedelnitsyn13/bedolaga/commit/4acebd192753643432a614c2a7f48eba6e9974fe))
...
* разорвать круговые импорты грейса и «онлайна» (CodeQL py/cyclic-import в [#3246](https://github.com/nedelnitsyn13/bedolaga/issues/3246)) ([fcdd68f](https://github.com/nedelnitsyn13/bedolaga/commit/fcdd68f0f5022693b33f4cefe60574700cdda89c))
...
* **structure:** пересобрать справку по структуре в порядке Linux ([1683df3](https://github.com/nedelnitsyn13/bedolaga/commit/1683df3e882aba8565140955313e4ca4af886e98))
...
* данные плательщика в платежах Platega и MulenPay — что уходит и откуда требование ([b688965](https://github.com/nedelnitsyn13/bedolaga/commit/b688965fad736b8528428f08f28956c83e69a23d))
