"""Колонки тарифа из миграции 0122 обязаны совпадать с моделью.
...
MIGRATION = '0122_tariff_panel_tag_and_trial_days.py'
NEW_COLUMNS = ('panel_tag', 'trial_duration_days')


def _load_migration():
    spec = importlib.util.spec_from_file_location('m0122', VERSIONS / MIGRATION)
